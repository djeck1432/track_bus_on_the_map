...
async def run_bus(route,route_id,buses_per_route,send_channel):
    bus_info = {
        "busId": None,
        "lat": None,
        "lng": None,
    ...
    async with send_channel:
        try:
            buses_info = create_description_route(bus_info,route,route_id,buses_per_route)
...
async def main():
    ...
    parser.add_argument('-x',default=20,type=int,help='buses_per_route')
    parser.add_argument('-w',default=10,type=int,help='websockets_number')
        ...
        async with send_channel, receive_channel:
            while True:
                for route in load_routes()[0:args.r]:
                    ...
                    nursery.start_soon(run_bus, route, route_id, args.x, send_channel.clone())
